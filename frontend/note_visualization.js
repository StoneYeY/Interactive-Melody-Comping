    ...
    class NoteVisual {
        ...
        setCycle(cycle) {
            if (this.painter && typeof this.painter.setCycle === 'function') {
                this.painter.setCycle(cycle);
            }
            if (this.piano && typeof this.piano.setCycle === 'function') {
    ...
    // Make NoteVisual and CONSTANTS available globally
    window.NoteVisual = NoteVisual;
